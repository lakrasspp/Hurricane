	...
	public class DisplaySettingsPanel extends Panel {
		public DisplaySettingsPanel(Panel back) {
			...
			middleColumn = add(showRowboatCircleAurasCheckBox = new CheckBox("Show Rowboat / Dugout Circle Auras"){
				...
				public void changed(boolean val) {
					Utils.setprefb("showRowboatCircleAuras", val);
					if (ui != null && ui.gui != null) {
						ui.sess.glob.oc.gobAction(Gob::updateRowboatAuras);
					}
				}
			}, middleColumn.pos("bl").adds(0, 18).x(UI.scale(240)));
			...
			add(new Button(UI.scale(70), "Reset", false).action(() -> {
				Utils.setprefsa("ambientColor" + "_colorSetting", new String[]{"255", "255", "255", "255"});
			...
			add(new Button(UI.scale(70), "Reset", false).action(() -> {
				Utils.setprefsa("diffuseColor" + "_colorSetting", new String[]{"255", "255", "255", "255"});
...
//	    y = addbtn(cont, "Take screenshot", GameUI.kb_shoot, y);
		...
		y = addbtn(cont,"Aggro pinged player", GameUI.kb_aggroPinged, y);
		...
		y = addbtnImproved(cont, "AutoDistance", "Trying to place you in ideal spot", Color.WHITE, GameUI.kb_autoDistance, y);
		...
		y+=UI.scale(20);
		y = addbtn(cont, "Steak maker", GameUI.kb_steakMaker, y);
		y+=UI.scale(20);

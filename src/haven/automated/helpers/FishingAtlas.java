...
public class FishingAtlas {
    ...
    public static final Set<String> fishingLines = new HashSet<>(Arrays.asList(
    ...
    public static final Set<String> fishingLures = new HashSet<>(Arrays.asList(
    ...
    public static final Set<String> fishingBaits = new HashSet<>(Arrays.asList(
    ...
    public static final Set<String> fishingOptions = new HashSet<>(Arrays.asList(

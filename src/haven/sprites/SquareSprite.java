...
public class SquareSprite extends Sprite {
	static final Pipe.Op blacc = Pipe.Op.compose(new BaseColor(new Color(0, 0, 0, 140)), new States.LineWidth(6), Clickable.notClickable);
	static final Pipe.Op col =  Pipe.Op.compose(new BaseColor(new Color(255,0,0,140)), Clickable.notClickable);
	...
	public SquareSprite(final Owner owner, Coord2d size, final Resource resource, Coord2d fixator) {
